...
<head>
    ...
    <title>Home - Ekstrakurikuler SMK Negeri 1 Garut</title>
    ...
    <meta property="og:description" content="SMK Negeri 1 Garut">
...
<nav class="navbar navbar-light navbar-expand-lg fixed-top" id="mainNav" style="background: var(--bs-primary);color: var(--bs-red);">
    <div class="container"><a class="navbar-brand" href="#page-top" style="color: var(--bs-white);">Main Title</a><button class="navbar-toggler navbar-toggler-right" data-bs-toggle="collapse" type="button" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation" data-bs-target="#navbarResponsive"><i class="fa fa-align-justify"></i></button></div>
</nav>
<section id="services">
    <div class="container py-4 py-xl-5">
        <div class="row mb-5">
            <div class="col-md-8 col-xl-6 text-center mx-auto">
                <h2>Esktrakulikuler SMK Negeri 1 Garut</h2>
                <hr class="my-4">
            </div>
        </div>
...
<footer class="text-center">
    <div class="container text-muted py-4 py-lg-5">
        ...
        <p class="mb-0">Copyright © 2022 Ekstrakurikuler SMK Negeri 1 Garut</p>
    </div>
</footer>
